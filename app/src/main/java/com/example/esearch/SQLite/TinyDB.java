...
public class TinyDB {
    ...
    public ArrayList<Produtos> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Produtos> playerList =  new ArrayList<Produtos>();

        for(String jObjString : objStrings){
            Produtos player  = gson.fromJson(jObjString,  Produtos.class);
    ...
    public void putListObject(String key, ArrayList<Produtos> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Produtos player: playerList){
